...
# CONTROLAR ELEMENTOS CON MÁS DE UN SELECTOR / PODES PONER LOS QUE QUIERAS...
#     EJ: //input[@type='text' and @id='userName']
...
mail = driver.find_element(
    By.XPATH, "//input[@id='userEmail' and @type='email']")
mail.send_keys("Linaresvelascomichael@gmail.com")
time.sleep(1)

direccion = driver.find_element(
    By.XPATH, "//textarea[contains(@id,'currentAddress') and @placeholder='Current Address']")
...
direccion_2 = driver.find_element(
...
boton = driver.find_element(
    By.XPATH, "//button[contains(@id,'submit') and @type='button']")
boton.click()
time.sleep(2)
